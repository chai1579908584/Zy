...
public class FuseRecordAdapter extends RecyclerView.Adapter<FuseRecordAdapter.My>{

    private final Context mContext;

    public FuseRecordAdapter(Context context){
        mContext=context;
    }
    @NonNull
    @Override
    public My onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.adapter_fuserecord, parent, false);
