...
public class ChainMessageAdapter extends RecyclerView.Adapter<ChainMessageAdapter.My>{

    private final Context mContext;
    private final List<String> messageList;

    public ChainMessageAdapter(Context context, List<String> messageList){
        mContext=context;
    ...
    public My onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.adapter_chainmessage, parent, false);
