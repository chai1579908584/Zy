...
import com.zhouyu.nft.fragment.HotSaleFragment;
import com.zhouyu.nft.fragment.OpenMysteryFragment;
import com.zhouyu.nft.fragment.PresellFragment;
import com.zhouyu.nft.fragment.PreviousFragment;
...
public class CollectionAdapter extends FragmentStatePagerAdapter {
    ...
    public CollectionAdapter(FragmentManager fm, Context context) {
        super(fm);
        mList.add(new PresellFragment(context));
        mList.add(new HotSaleFragment(context));
        mList.add(new PreviousFragment(context));
    }
