...
public class AccomplishFragment extends Fragment  {
    ...
    Context mContext;
    public AccomplishFragment(Context context){
        mContext=context;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View inflate = inflater.inflate(R.layout.fragment_accomplish, container, false);
    ...
    private void requestData(boolean refresh, RefreshLayout cancel) {
        ...
        YzApi.getMyOrder(mContext, page, "2",new GXCallback<UnpaidBean>() {
            @Override
            public void onSuccess(UnpaidBean response, int id) {
                ...
                if (unpaidAdapter == null) {
                    ...
                    unpaidAdapter.setOnClickListener(id1 -> {
