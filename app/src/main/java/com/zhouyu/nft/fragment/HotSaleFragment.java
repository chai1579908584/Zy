...
public class HotSaleFragment extends Fragment {
    ...
    public HotSaleFragment(Context context) {
        mContext = context;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View inflate = inflater.inflate(R.layout.fragment_hotsale, container, false);
    ...
    private void requestData(boolean refresh, RefreshLayout cancel) {
        ...
        YzApi.getSale(mContext, page, new GXCallback<PresellBean>() {
            @Override
